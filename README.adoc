...
:page-seo-title: Deploying a microservice to Red Hat OpenShift 4 by using a Open Liberty Operator
...
= Deploying a microservice to OpenShift 4 by using a Open Liberty Operator

[.hidden]
NOTE: This repository contains the guide documentation source. To view the guide in published form, view it on the https://openliberty.io/guides/{projectid}.html[Open Liberty website^].

Explore how to deploy a microservice to Red Hat OpenShift by using a Open Liberty Operator.
