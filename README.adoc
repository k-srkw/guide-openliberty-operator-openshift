...
There are various OpenShift offerings. You can use the https://learn.openshift.com/playgrounds[online playground^], which provides free access to an OpenShift cluster for 60 minutes. Alternatively, you can gain access to an OpenShift cluster that is hosted on https://www.openshift.com/products/openshift-ibm-cloud[IBM Cloud^], or check out other offerings https://www.openshift.com/products[from OpenShift^]. 
