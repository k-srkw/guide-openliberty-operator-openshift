...
Namespace:                {os-project}
Created:                  2 minutes ago
Labels:                   name=system
Annotations:              <none>
Image Repository:         default-route-openshift-image-registry.apps-crc.testing/{os-project}/system-imagestream
...
```
NAME     IMAGE                                        EXPOSED   RECONCILED   AGE
system   sn-lab-user/system-imagestream:1.0-SNAPSHOT  true      True         10s
```
endif::[]
